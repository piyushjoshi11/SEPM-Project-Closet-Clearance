# Closet Clearance ECommerce Website
...
```
$ git clone git@github.com:VaibhavMishra17/sepm-project.git
$ cd sepmproject
```
...
- Local MongoDB
  ...
  - Set MONGODB_URL=mongodb://localhost/closetclearance
- Atlas Cloud MongoDB
...
- Q/A: vm6659@srmist.edu.in
- Contact Developer: [Vaibhav Mishra](mailto:vm6659@srmist.edu.in)

## Lessons

1. Introduction to this webiste
   1. Ecommerce website build with react, nodejs, mongodb
   2. Sell ans buy expensive used clothes online
   3. Anyone can sell and buy
2. Install Tools
   1. Code Editor
   2. Web Browser
   3. VS Code Extension
3. Website Template
   1. Create closet clearance folder
...
45. Publish To Heroku
    ...
    4. heroku login
    5. heroku apps:create <yourname>closet clearance
